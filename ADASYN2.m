function [out_featuresSyn, out_labelsSyn] = ADASYN2(in_features, in_labels, in_beta, in_kDensity, in_kSMOTE, in_featuresAreNormalized,minLabel,majLabel)
...
%
%minLabel: Define class which is needed to expand
%majLabel: Other (not expended) class
% OUTPUTS:
%----------
